...
import com.alparslanturk.bulbiletini.databinding.ActivityAddCommentBinding
...
class AddCommentActivity : BaseActivity() {
    ...
    private val viewModel by viewModels<AddCommentViewModel>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding) {
            btnAddComment.setOnClickListener {
                viewModel.addComment(AddCommentRequest(userId = userID, createdUserId = getUserID(), comment = edtComment.text.toString()))
            }
        }
    }
    ...
    override fun onResume() {
        super.onResume()
        mFirebaseUtils.logScreenViewEvent("Add Comment Page", AddCommentActivity::class.java.name)
    }
                            ...
                            is Result.Success -> {
                                ...
                                it.body?.apply {
                                    if (code == 200) {
                                        isAnyUpdate = true
                                        returnResult()
                                        Toast.makeText(this@AddCommentActivity, getString(R.string.comment_added_successful), Toast.LENGTH_LONG).show()
                                    } else {
    ...
    companion object {
        ...
        fun createIntent(context: Context, userID: String): Intent {
            return Intent(context, AddCommentActivity::class.java).apply {
